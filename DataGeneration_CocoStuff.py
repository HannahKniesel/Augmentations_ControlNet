...
if __name__ == "__main__":
    ...
    images_folder = "/images/train2014/"
    annotations_folder = "/annotations/train2014/"
    ...
    for img_idx, path in enumerate(data_paths): 
        ...
        # save image TODO check data format
        pil_img = Image.fromarray(init_image)
        pil_img.save(save_path+images_folder+Path(path).stem+".jpg")
        # copy GT
        shutil.copy(annotation_path, save_path+annotations_folder+Path(path).stem+"_labelTrainIds.png")
        ...
        for i in range(args.num_augmentations):
            ...
            # save augmented image TODO check data format
            ...
            shutil.copy(annotation_path, save_path+annotations_folder+name+"_labelTrainIds.png")
