...
#     best = "minimum"
def smu_loss(input, real_images, model, visualize = False):
    out = forward_model(input,model)
...
#     best = "minimum"
def lmu_loss(input,real_images, model, visualize = False):
    out = forward_model(input,model)
...
#     best = "minimum"
def lcu_loss(input, real_images, model, visualize = False):
    out = forward_model(input,model)
    maximum = torch.max(out, dim = 1).values
...
#     best = "maximum"
def entropy_loss(input, real_images, model, visualize = False):
...
def loss_brightness(images, real_images, model, visualize = False): 
...
def mse_loss(generated_images, real_images, model, visualize = False):
